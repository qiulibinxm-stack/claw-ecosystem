# Use nircmd or built-in tools to take screenshot
# Try using Python instead since PS variable issue
import ctypes
...
gdi32.BitBlt(hdcMem, 0, 0, width, height, hdc, 0, 0, 0x00CC0020)  # SRCCOPY

# Save to file using PIL
from PIL import Image
import io

bmp_info = gdi32.GetObjectW(hbmp, ctypes.sizeof(ctypes.c_void_p), None)
img = Image.frombuffer('RGB', (width, height), None, 'raw', 'BGRX', 0, 1)
...
img.save('C:\\temp\\dt_py.jpg', 'JPEG', quality=85)
