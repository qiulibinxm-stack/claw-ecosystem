 ...
 * 格式化单个仓库为 Markdown
 */
export function formatRepoMarkdown(repo: Repository, rank: number): string {
 ...
 * 格式化扫描结果为 Markdown
 */
export function formatScanResultMarkdown(results: TrendingScanResult[]): string {
  const lines: string[] = [];
 ...
 * 格式化扫描结果为 JSON
 */
export function formatScanResultJson(results: TrendingScanResult[]): string {
 ...
 * 格式化学习简报为 Markdown
 */
export function formatBriefMarkdown(brief: LearningBrief): string {
  const lines: string[] = [];
 ...
 * 格式化学习简报为 JSON
 */
export function formatBriefJson(brief: LearningBrief): string {
 ...
 * 生成摘要表格（Markdown）
 */
export function generateSummaryTable(results: TrendingScanResult[]): string {
  const lines: string[] = [];
