...
print(f'Already done: {done}, Remaining: {len(pdfs)-done}', flush=True)
...
for i, pf in enumerate(pdfs):
    ...
    print(f'[{i+1}/{len(pdfs)}] {pf}', flush=True)
    try:
